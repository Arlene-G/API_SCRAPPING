...
USER_AGENT = 'https://whatismybrowser.com/w/RFLZARY'
REQUEST_HEADER = {
...
if __name__ == "__main__":
    ...
    send_email('send_from@gmail.com', ['send_to@gmail.com'],
               'Job posting', 'Please, find attached a list of job posting to this email', files=['remote_jobs.xls'])
